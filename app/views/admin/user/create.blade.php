    ...
    <div class="col-lg-12">
        <div class="form-panel">
            ...
            <h2 class="mb">New User</h2>
                ...
                <div class="form-group optional-teacher @if(MessageService::has('school')) has-error @endif">
                ...
                <div class="form-group optional-teacher @if(MessageService::has('unit_required_for')) has-error @endif">
