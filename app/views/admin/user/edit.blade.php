    ...
    <div class="col-lg-12">
        <div class="form-panel">
            @if(empty($messages) == false)
                ...
                @endforeach
            @endif
            <h4 class="mb"><i class="fa fa-angle-right"></i> Details for {{$user->email }}</h4>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="unit_required_for" value="{{$user->unit_required_for}}">
                    </div>
                </div>
                <div class="form-group">
