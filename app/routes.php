...
Route::post('/forgetpassword', ['uses' => 'SessionController@storeForgetPassword', 'as' => 'session.storeForgetPassword']);
...
Route::get('/teacher/{period}/edit', ['uses' => 'TeacherController@periodEdit', 'as' => 'teacher.period.edit', 'before' => 'teacher']);
Route::post('/teacher/{period}/edit', ['uses' => 'TeacherController@storePeriodEdit', 'as' => 'teacher.period.storeEdit', 'before' => 'teacher']);
...
Route::get('/teacher/{period}/form/{formId}/edit', ['uses' => 'TeacherController@formEdit', 'as' => 'teacher.form.edit', 'before' => 'teacher']);
Route::post('/teacher/{period}/form/{formId}/edit', ['uses' => 'TeacherController@storeFormEdit', 'as' => 'teacher.form.edit', 'before' => 'teacher']);
